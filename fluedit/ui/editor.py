...
# Form implementation generated from reading ui file './qt/editor.ui'
#
...
class Ui_Editor(object):
    def setupUi(self, Editor):
        ...
        self.original_message_edit = QtWidgets.QTextEdit(self.widget)
        ...
        self.is_draft_box = QtWidgets.QCheckBox(self.widget1)
        ...
        self.translited_message_edit = QtWidgets.QTextEdit(self.widget1)
    ...
    def retranslateUi(self, Editor):
        ...
        self.comboBox.setItemText(0, _translate("Editor", "None"))
        self.comboBox.setItemText(1, _translate("Editor", "Drafts"))
        self.comboBox.setItemText(2, _translate("Editor", "Untranslated"))
        self.comboBox.setItemText(3, _translate("Editor", "Translated"))
        self.comboBox.setItemText(4, _translate("Editor", "With comments"))
        self.comboBox.setItemText(5, _translate("Editor", "Without comments"))
