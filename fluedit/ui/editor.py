...
class Ui_Editor(object):
    def setupUi(self, Editor):
        ...
        self.msg_source_fname_box = QtWidgets.QLineEdit(self.verticalLayoutWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.msg_source_fname_box.sizePolicy().hasHeightForWidth())
        self.msg_source_fname_box.setSizePolicy(sizePolicy)
        self.msg_source_fname_box.setReadOnly(True)
        self.msg_source_fname_box.setObjectName("msg_source_fname_box")
        self.horizontalLayout_2.addWidget(self.msg_source_fname_box)
        self.msg_source_line_box = QtWidgets.QLineEdit(self.verticalLayoutWidget_2)
        self.msg_source_line_box.setMaximumSize(QtCore.QSize(70, 16777215))
        self.msg_source_line_box.setReadOnly(True)
        self.msg_source_line_box.setObjectName("msg_source_line_box")
        self.horizontalLayout_2.addWidget(self.msg_source_line_box)
        self.verticalLayout_8.addLayout(self.horizontalLayout_2)
        self.label_5 = QtWidgets.QLabel(self.verticalLayoutWidget_2)
        self.label_5.setObjectName("label_5")
        self.verticalLayout_8.addWidget(self.label_5)
        self.memoirs_list = QtWidgets.QListWidget(self.verticalLayoutWidget_2)
        self.memoirs_list.setObjectName("memoirs_list")
        self.verticalLayout_8.addWidget(self.memoirs_list)
        ...
        self.memoirs_list.itemActivated['QListWidgetItem*'].connect(Editor.on_memoirs_activated)
    ...
    def retranslateUi(self, Editor):
        ...
        self.label_3.setText(_translate("Editor", "File"))
        self.msg_source_fname_box.setPlaceholderText(_translate("Editor", "undefined"))
        self.msg_source_line_box.setPlaceholderText(_translate("Editor", "undefined"))
